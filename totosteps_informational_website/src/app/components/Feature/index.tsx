...
export default function Features() {
  return (
    <section id="features" className={`py-16 sm:py-24 px-6 sm:px-6   bg-white text-black ${nunito.className}`}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-12 sm:mb-16">Empowering Features for Caring Parents</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 sm:gap-16">
          {features.map((feature, index) => (
